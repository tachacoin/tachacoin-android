...
import org.tachacoin.wallet.ui.fragment.token_fragment.TokenInteractor;
import org.tachacoin.wallet.ui.fragment.token_fragment.TokenPresenterImpl;
import org.tachacoin.wallet.ui.fragment.token_fragment.TokenView;
...
public class TokenPresenterTest {
    ...
    public void initialize_TokenWithDecimals() {
        ...
        verify(view, times(1)).setTachacoinAddress(interactor.getCurrentAddress());

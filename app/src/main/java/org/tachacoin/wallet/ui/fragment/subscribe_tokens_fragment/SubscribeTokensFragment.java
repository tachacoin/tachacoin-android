...
import org.tachacoin.wallet.utils.SearchBar;
import org.tachacoin.wallet.utils.SearchBarListener;
...
public abstract class SubscribeTokensFragment extends BaseFragment implements SubscribeTokensView, SearchBarListener {
    ...
    @BindView(org.tachacoin.wallet.R.id.recycler_view)
    protected
    RecyclerView mRecyclerView;

    @BindView(org.tachacoin.wallet.R.id.tv_currency_title)
    TextView mTextViewCurrencyTitle;

    @BindView(org.tachacoin.wallet.R.id.search_bar)
    SearchBar searchBar;
    ...
    public void initializeViews() {
        ...
        mTextViewCurrencyTitle.setText(org.tachacoin.wallet.R.string.chose_to_subscribe);
    ...
    class TokenHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(org.tachacoin.wallet.R.id.tv_single_string)
        TextView mTextViewCurrency;
        @BindView(org.tachacoin.wallet.R.id.iv_check_indicator_blue)
        ImageView mImageViewCheckIndicator;
        @BindView(org.tachacoin.wallet.R.id.ll_single_item)

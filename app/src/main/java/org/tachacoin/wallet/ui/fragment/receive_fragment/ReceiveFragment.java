package org.tachacoin.wallet.ui.fragment.receive_fragment;
...
import org.tachacoin.wallet.ui.activity.main_activity.FragmentKeyboardEventListener;
...
public abstract class ReceiveFragment extends BaseFragment implements ReceiveView, FragmentKeyboardEventListener {
    ...
    private void chooseShareMethod() {
        if (getQrCode() != null) {
            String pathofBmp = MediaStore.Images.Media.insertImage(getContext().getContentResolver(), getQrCode(), "TACHACOIN QRCode", "Share");
            ...
            getMainActivity().startActivity(Intent.createChooser(intentShareFile, "Tachacoin QR-Code"));
        }
    }

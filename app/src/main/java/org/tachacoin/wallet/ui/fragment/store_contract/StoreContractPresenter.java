...
import org.tachacoin.wallet.ui.fragment.send_fragment.SendInteractorImpl;
...
import static org.tachacoin.wallet.datastorage.FileStorageManager.HUMANSTANDARDTOKENUUID;
        ...
        getUnspentOutputs(new SendInteractorImpl.GetUnspentListCallBack() {
            ...
            public void onSuccess(List<UnspentOutput> unspentOutputs) {
                ...
                try {
                    ...
                    callBack.onError(getView().getContext().getString(R.string.invalid_tachacoin_address));
                    return;
                }
                //TODO STUB!

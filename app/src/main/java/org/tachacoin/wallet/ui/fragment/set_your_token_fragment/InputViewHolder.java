...
import org.tachacoin.wallet.utils.EditTextValidated;
...
public abstract class InputViewHolder extends RecyclerView.ViewHolder implements EditTextValidated.EditTextValidateListener {
    ...
    @BindView(org.tachacoin.wallet.R.id.til_param)
    protected
    TextInputLayout tilParam;

    @BindView(org.tachacoin.wallet.R.id.et_param)
    protected
    EditTextValidated etParam;

    @BindView(org.tachacoin.wallet.R.id.checkbox)

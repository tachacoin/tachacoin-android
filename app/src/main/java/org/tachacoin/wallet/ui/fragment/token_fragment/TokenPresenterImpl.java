...
import org.tachacoin.wallet.model.gson.history.HistoryPayType;
...
public class TokenPresenterImpl extends BaseFragmentPresenterImpl implements TokenPresenter {
    ...
    private void setTachacoinAddress() {
        getView().setTachacoinAddress(getInteractor().getCurrentAddress());
    }

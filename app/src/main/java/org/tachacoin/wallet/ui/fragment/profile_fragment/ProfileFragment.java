...
import org.tachacoin.wallet.ui.fragment.about_fragment.AboutFragment;
...
import static org.tachacoin.wallet.ui.fragment.pin_fragment.PinAction.AUTHENTICATION_FOR_PASSPHRASE;
import static org.tachacoin.wallet.ui.fragment.pin_fragment.PinAction.CHANGING;
...
public abstract class ProfileFragment extends BaseNavFragment implements ProfileView, OnSettingClickListener {
    ...
    @BindView(org.tachacoin.wallet.R.id.pref_list)
    ...
    public void onSettingClick(int key) {
        ...
        switch (key) {
            ...
            case org.tachacoin.wallet.R.string.log_out:
                ...
                break;
            case org.tachacoin.wallet.R.string.switch_theme:
    ...
    public void onSwitchChange(int key, boolean isChecked) {
        switch (key) {
            case org.tachacoin.wallet.R.string.touch_id:

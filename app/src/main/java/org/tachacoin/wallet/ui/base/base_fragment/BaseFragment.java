...
import org.tachacoin.wallet.ui.fragment.processing_dialog.ProcessingDialogFragment;
...
public abstract class BaseFragment extends Fragment implements BaseFragmentView {
    ...
    public void setAlertDialog(String title, String message, String buttonText, PopUpType type, final AlertDialogCallBack callBack) {
        try {
            ...
            dismissAlertDialog();
            View view = LayoutInflater.from(getContext()).inflate(ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK) ? org.tachacoin.wallet.R.layout.dialog_popup_fragment : org.tachacoin.wallet.R.layout.dialog_popup_fragment_light, null);

            FontTextView tvTitle = ((FontTextView) view.findViewById(org.tachacoin.wallet.R.id.tv_pop_up_title));
            tvTitle.setText(title);
            FontTextView tvMessage = ((FontTextView) view.findViewById(org.tachacoin.wallet.R.id.tv_pop_up_message));
            tvMessage.setText(message);
            FontButton popUpButton = ((FontButton) view.findViewById(org.tachacoin.wallet.R.id.bt_pop_up));
            view.findViewById(org.tachacoin.wallet.R.id.bt_pop_up2).setVisibility(View.GONE);

            ImageView icon = ((ImageView) view.findViewById(org.tachacoin.wallet.R.id.iv_icon));
            ...
            if (ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK)) {
                switch (type.name()) {
                    case "error":
                        icon.setImageResource(org.tachacoin.wallet.R.drawable.ic_error);
                        view.findViewById(org.tachacoin.wallet.R.id.red_line).setVisibility(View.VISIBLE);
                        break;
                    case "confirm":
                        icon.setImageResource(org.tachacoin.wallet.R.drawable.ic_confirm);
                        view.findViewById(org.tachacoin.wallet.R.id.red_line).setVisibility(View.GONE);
                        break;
                }
            } else {
                switch (type.name()) {
                    case "error":
                        tvTitle.setTextColor(ContextCompat.getColor(getContext(), org.tachacoin.wallet.R.color.title_red_color));
                        icon.setImageResource(org.tachacoin.wallet.R.drawable.ic_popup_error_light);
                        break;
                    case "confirm":
                        icon.setImageResource(org.tachacoin.wallet.R.drawable.ic_confirmed_light);
                        break;
                }
            }
    ...
    public void setAlertDialog(String title, String message, String buttonText, String buttonText2, PopUpType type, final AlertDialogCallBack callBack) {
        try {
            ...
            tvMessage.setText(message);
            FontButton popUpButton = ((FontButton) view.findViewById(org.tachacoin.wallet.R.id.bt_pop_up));
            FontButton popUpButton2 = ((FontButton) view.findViewById(org.tachacoin.wallet.R.id.bt_pop_up2));
            view.findViewById(org.tachacoin.wallet.R.id.bt_pop_up2).setVisibility(View.VISIBLE);
    ...
    public void openRootFragment(Fragment fragment) {
        ...
        getFragmentManager()
                .beginTransaction()
                .replace(org.tachacoin.wallet.R.id.fragment_container, fragment, fragment.getClass().getCanonicalName())
    ...
    public void openFragment(Fragment fragment) {
        if(getFragmentManager().findFragmentByTag(fragment.getClass().getCanonicalName())==null) {
            ...
            getFragmentManager()
                    ...
                    .add(org.tachacoin.wallet.R.id.fragment_container, fragment, fragment.getClass().getCanonicalName())
                    .addToBackStack(null)
                    .commit();
        }
    }

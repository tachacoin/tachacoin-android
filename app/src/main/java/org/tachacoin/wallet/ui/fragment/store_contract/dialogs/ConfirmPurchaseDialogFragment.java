package org.tachacoin.wallet.ui.fragment.store_contract.dialogs;
...
public class ConfirmPurchaseDialogFragment extends AppCompatDialogFragment {
    ...
    @BindView(org.tachacoin.wallet.R.id.contract_name)
    FontTextView tvContractName;

    @BindView(org.tachacoin.wallet.R.id.contract_type)
    FontTextView tvContractType;

    @BindView(org.tachacoin.wallet.R.id.price)
    FontTextView tvPrice;

    @BindView(org.tachacoin.wallet.R.id.miner_address)
    FontTextView tvMinerAddress;

    @OnClick(org.tachacoin.wallet.R.id.btn_cancel)
    public void onCancelClick() {
        dismiss();
    }

    @OnClick(org.tachacoin.wallet.R.id.btn_confirm)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate((ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK) ? org.tachacoin.wallet.R.layout.lyt_confirm_purchase : org.tachacoin.wallet.R.layout.lyt_confirm_purchase_light), container, false);

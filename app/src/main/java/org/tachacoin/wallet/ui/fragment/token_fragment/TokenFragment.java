...
import org.tachacoin.wallet.ui.fragment.token_fragment.dialogs.ShareDialogFragment;
...
public abstract class TokenFragment extends BaseFragment implements TokenView, TokenHistoryClickListener {
    ...
    private static final String tachacoinAddressKey = "tachacoinAddressKey";
    ...
    @Override
    public void setTachacoinAddress(String address) {
        if (!TextUtils.isEmpty(address)) {

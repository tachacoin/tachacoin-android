package org.tachacoin.wallet.ui.fragment.wallet_fragment.dark;
...
import org.tachacoin.wallet.utils.ResizeWidthAnimation;
...
public class WalletFragmentDark extends WalletFragment {
    ...
    public void updateBalance(String balance, String unconfirmedBalance) {
        try {
            balanceValue.setText(String.format("%s TACHACOIN", balance));
            if (unconfirmedBalance != null) {
                ...
                uncomfirmedBalanceValue.setText(String.format("%s TACHACOIN", unconfirmedBalance));
            } else {
                uncomfirmedBalanceValue.setVisibility(View.GONE);
                uncomfirmedBalanceTitle.setVisibility(View.GONE);
            }

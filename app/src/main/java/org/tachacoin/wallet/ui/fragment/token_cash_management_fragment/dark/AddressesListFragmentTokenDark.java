...
import org.tachacoin.wallet.ui.fragment.token_cash_management_fragment.AddressesListFragmentToken;
import org.tachacoin.wallet.ui.fragment.token_cash_management_fragment.TokenAddressesAdapter;
...
public class AddressesListFragmentTokenDark extends AddressesListFragmentToken {
    ...
    protected int getLayout() {
        return org.tachacoin.wallet.R.layout.fragment_address_list;
    }

    @Override
    public void updateAddressList(List<AddressWithTokenBalance> deterministicKeyWithBalance, String currency) {
        if (mRecyclerView != null) {
            adapter = new TokenAddressesAdapter(deterministicKeyWithBalance, org.tachacoin.wallet.R.layout.item_address, this, currency, getPresenter().getDecimalUnits());
    ...
    protected void showTransferDialogFragment(final AddressWithTokenBalance keyWithBalanceTo, List<AddressWithTokenBalance> keyWithBalanceList, final int decimalUnits) {
        View view = LayoutInflater.from(getContext()).inflate(org.tachacoin.wallet.R.layout.dialog_transfer_balance_fragment, null);
        final TextInputEditText mEditTextAmount = (TextInputEditText) view.findViewById(org.tachacoin.wallet.R.id.et_amount);
        final Spinner spinner = (Spinner) view.findViewById(org.tachacoin.wallet.R.id.spinner_transfer);
        FontTextView mEditTextAddressTo = (FontTextView) view.findViewById(org.tachacoin.wallet.R.id.tv_address_to);
        ...
        view.findViewById(org.tachacoin.wallet.R.id.bt_back).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        view.findViewById(org.tachacoin.wallet.R.id.bt_transfer).setOnClickListener(new View.OnClickListener() {
            @Override

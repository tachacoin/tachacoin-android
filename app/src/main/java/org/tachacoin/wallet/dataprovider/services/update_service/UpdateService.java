package org.tachacoin.wallet.dataprovider.services.update_service;
...
import org.tachacoin.wallet.dataprovider.firebase.FirebaseSharedPreferences;
import org.tachacoin.wallet.dataprovider.firebase.listeners.FireBaseTokenRefreshListener;
...
import org.tachacoin.wallet.utils.BoughtContractBuilder;

import org.tachacoin.wallet.R;
import org.tachacoin.wallet.dataprovider.services.update_service.listeners.ContractPurchaseListener;
import org.tachacoin.wallet.dataprovider.services.update_service.listeners.TokenListener;
import org.tachacoin.wallet.dataprovider.services.update_service.listeners.TransactionListener;
...
import static org.tachacoin.wallet.WearListCallListenerService.ADDRESS;
import static org.tachacoin.wallet.WearListCallListenerService.BALANCE;
import static org.tachacoin.wallet.WearListCallListenerService.CURR_TIME_MILLS;
import static org.tachacoin.wallet.WearListCallListenerService.ITEMS;
import static org.tachacoin.wallet.WearListCallListenerService.UNC_BALANCE;
import static org.tachacoin.wallet.utils.StringUtils.convertBalanceToString;
...
public class UpdateService extends Service implements GoogleApiClient.ConnectionCallbacks {
    ...
    public void onCreate() {
        ...
        final TachacoinSharedPreference tachacoinSharedPreference = TachacoinSharedPreference.getInstance();

        String balanceString = tachacoinSharedPreference.getBalanceString(getApplicationContext());
        final String unconfirmedBalanceString = tachacoinSharedPreference.getUnconfirmedBalanceString(getApplicationContext());
        Long lastUpdatedBalanceTime = tachacoinSharedPreference.getLastUpdatedBalanceTime(getApplicationContext());
            ...
            public void call(Object... args) {
                try {
                    ...
                    try {
                        ...
                        tachacoinSharedPreference.setBalanceString(getApplicationContext(), balance.toString());
                        tachacoinSharedPreference.setUnconfirmedBalanceString(getApplicationContext(), unconfirmedBalance.toString());
                        tachacoinSharedPreference.setLastUpdatedBalanceTime(getApplicationContext(), mLastUpdatedBalanceTime);
    ...
    private void onBalanceChange() {
        TachacoinService.newInstance().getHistoryListForSeveralAddresses(addresses, 10, 0)

...
import org.tachacoin.wallet.utils.migration_manager.KeystoreMigrationResult;

import java.util.ArrayList;
import java.util.List;
import java.util.Locale;

public class TachacoinSharedPreference {
    private static TachacoinSharedPreference sInstance = null;

    private final String TACHACOIN_DATA_STORAGE = "tachacoin_data_storage";
    private final String TACHACOIN_PASSWORD = "tachacoin_wallet_password";
    private final String TACHACOIN_SIX_DIGIT_PASSWORD = "tachacoin_wallet_six_digit_password";
    private final String TACHACOIN_IS_KEY_GENERATED = "tachacoin_is_key_generated";
    private final String TACHACOIN_SEED = "tachacoin_seed";
    ...
    private TachacoinSharedPreference() {

    }

    public static TachacoinSharedPreference getInstance() {
        if (sInstance == null) {
            sInstance = new TachacoinSharedPreference();
        }
        return sInstance;
    }

    public String getKeystoreMigrationState(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getString(passphrase_migration_state
                , null);
    }

    public void setKeyStoreMigrationState(Context context, String state) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE);
    ...
    public boolean isTouchIdEnable(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getBoolean(TOUCH_ID_ENABLE, false);
    }

    public void savePassword(Context context, String password) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE);
        SharedPreferences.Editor mEditor = mSharedPreferences.edit();
        mEditor.putString(TACHACOIN_PASSWORD, password);
        mEditor.apply();
    }

    public String getPassword(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getString(TACHACOIN_PASSWORD, "");
    }
    ...
    public String getCurrentAddress(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getString(CURRENT_ADDRESS, null);
    }
    ...
    public Long getBanTime(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getLong(BAN_TIME, 0);
    }
    ...
    public Integer getFailedAttemptsCount(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getInt(FAILED_ATTEMPTS_COUNT, 0);
    }

    public void saveSixDigitPassword(Context context, String password) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE);
        SharedPreferences.Editor mEditor = mSharedPreferences.edit();
        mEditor.putString(TACHACOIN_SIX_DIGIT_PASSWORD, password);
        mEditor.apply();
    }

    public String getSixDigitPassword(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getString(TACHACOIN_SIX_DIGIT_PASSWORD, "");
    }
    ...
    public String getTouchIdPassword(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getString(TOUCH_ID_PASSWORD, "");
    }

    public void setKeyGeneratedInstance(Context context, boolean isKeyGenerated) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE);
        SharedPreferences.Editor mEditor = mSharedPreferences.edit();
        mEditor.putBoolean(TACHACOIN_IS_KEY_GENERATED, isKeyGenerated);
        mEditor.apply();
    }

    public boolean getKeyGeneratedInstance(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getBoolean(TACHACOIN_IS_KEY_GENERATED, false);
    }



    public String getSeed(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getString(TACHACOIN_SEED, "");
    }

    public void saveSeed(Context context, String seed) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE);
        SharedPreferences.Editor mEditor = mSharedPreferences.edit();
        mEditor.putString(TACHACOIN_SEED, seed);
        mEditor.apply();
    }
    ...
    public Integer getMinGasPrice(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getInt(MIN_GAS_PRICE, 40);
    }
    ...
    public String getBalanceString(Context context){
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getString(BALANCE_STRING,"0");
    }
    ...
    public String getUnconfirmedBalanceString(Context context){
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getString(UNCONFIRMED_BALANCE_STRING,"0");
    }
    ...
    public Long getLastUpdatedBalanceTime(Context context) {
        return context.getSharedPreferences(TACHACOIN_DATA_STORAGE, Context.MODE_PRIVATE).getLong(LAST_UPDATED_BALANCE_TIME, 0);
    }

...
public class SearchBar extends RelativeLayout implements View.OnClickListener{
    ...
    private void build(){
        setClickable(true);
        placeholderIcon = (ImageView) findViewById(org.tachacoin.wallet.R.id.icon);
        placeholderText = (TextView) findViewById(org.tachacoin.wallet.R.id.text);
        input = (EditText) findViewById(org.tachacoin.wallet.R.id.input);
        placeholder = (LinearLayout) findViewById(org.tachacoin.wallet.R.id.placeholder);
        cancel = (Button) findViewById(org.tachacoin.wallet.R.id.cancel);

        clearSearch = (ImageView) findViewById(org.tachacoin.wallet.R.id.bt_clear_search);

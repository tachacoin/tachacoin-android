...
public class FontTextInputEditText extends TextInputEditText {
    ...
    public FontTextInputEditText(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, org.tachacoin.wallet.R.styleable.FontTextInputEditText);

        if (ta != null) {
            String fontAsset = ta.getString(org.tachacoin.wallet.R.styleable.FontTextInputEditText_inputTypeface);

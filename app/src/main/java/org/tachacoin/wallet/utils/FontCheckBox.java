...
public class FontCheckBox extends AppCompatCheckBox {
    ...
    public FontCheckBox(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, org.tachacoin.wallet.R.styleable.FontCheckBox);

        if (ta != null) {
            String fontAsset = ta.getString(org.tachacoin.wallet.R.styleable.FontCheckBox_checkBoxTypeface);
